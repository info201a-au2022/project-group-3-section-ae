...
## **_Abstract_**  
Our main question is which countries in North and South America have the best living conditions for its citizens. This question is important because it highlights which countries in those regions have the best and affordable services offered to its people. To address this question, we will focus on three main areas: crime rates, cost of living and healthcare affordability.
...
Research Q2: (Cost of Living): Which countries have the most affordable cost of living regards to food and groceries?
...
2) Cost of living is another main issue we all think of these days. The ranking of the countries is a good indicator of where we should live and how we can live life financially generally and through food aspect. This is especially important because everyone needs to know how they spend their finances daily.  This eventually could have a major impact on our emotions and happiness. Depending on higher rankings, this would motivate yourself to more job opportunities and higher salaries in the future.
...
The healthcare expenditures relate to our problem domain because it helps answer the question which countries in the North and South America has the most affordable healthcare. This dataset shows how much out of pocket expenditure for healthcare occurs in each country. The dataset and the healthcare index dataset together will help answer the question which countries have the most viable healthcare based on quality service and price.
...
Some expected implications within our topic consist of adding a better system to crime rates in any area with a high or low percentage. Crime is present everywhere so this is a universal problem people encounter but it is very important to address. Something that would work is adding cameras to designated places where more public is around, to watch over everyone and create an atmosphere where there are consequences for your actions. In addition, adding more police departments around the city in close vicinity to houses and on the street as well to keep everyone protected. Another expected implication if an area has a good quality of life but struggles with accessibility specifically through health care, could be looking into mobile clinics that can go through cities and more rural areas. This would help increase access to healthcare aids for people and would support the citizens in various ways.

## **_Limitations_**      
Two limitations that come to mind are missing data and various responses from a website. Our first limitation was that some databases included missing data for some particular nations. This would limit and impede our ability to assess the overall quality of life. From this observation, we will breakdown the countries that have data for the countries in those regions. The second constraint was that one of our sets of data was derived by survey responses. Although there are statistics on nations, it might be biased because there may be some people that could answer questions inaccurately which possibly leads to the inaccuracy of our calculations. This could also lead to other people being skewed about the particular calculations. Since this would restrict our technique of evaluating data, we will make sure to consider specific information from multiple years to adequately perform our computations.
