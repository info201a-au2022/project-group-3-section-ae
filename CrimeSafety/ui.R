...
navbarPage(
  ...
  tabPanel("Chart2",
           ...
           # Slidebar
           sliderInput("slider1", label = h3("Slider"), min = 50,
                       max = 80, value = 50),
             ...
             #),
           h3("The map shows the healthcare indexes of each country.The lighter the color the better the healthcare services
              in that particular country and vice versa. The slider to the left controls the range of healthcare indexes among certain countries. For eaxample when the user slidess the slider to 60 the map will display countries with a healthcare index of 60 or lower.")
  ),
